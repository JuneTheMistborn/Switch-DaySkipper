...
##### My experience:
Firstly you need to create a folder where you are going to work with this project, then download the above files, and extract them into your premade folder. Then extract the LUFA zip into the folder you created (not the Switch-DaySkipper directory you just downloaded). Next you must download mingw32 from here: http://osdn.net/projects/mingw/downloads/68260/mingw-get-setup.exe/, once you get to the mingw32
